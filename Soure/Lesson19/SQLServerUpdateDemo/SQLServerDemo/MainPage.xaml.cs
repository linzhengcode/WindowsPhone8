...
namespace SQLServerDemo
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            Order order1 = new Order { Customer = customer, Name = "order1_" + i, OrderID = i, CustomerID = "CustomerID1" + i, Desc ="desc", Salesman="张三"};
            MyDataContext.OrderTable.InsertOnSubmit(order1);
            Order order2 = new Order { Customer = customer, Name = "order2_" + i, OrderID = i, CustomerID = "CustomerID2" + i, Desc = "desc", Salesman = "李四" };
        ...
        {
            Company company = new Company { Name = "公司" };
            MyDataContext.CompanyTable.InsertOnSubmit(company);
            MyDataContext.SubmitChanges();
            MessageBox.Show("成功插入");
        }
