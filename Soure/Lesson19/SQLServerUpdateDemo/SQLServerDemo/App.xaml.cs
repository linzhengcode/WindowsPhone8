    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            using (MyDataContext db = new MyDataContext(DBConnectionString))
            {
                ...
                {
                    DatabaseSchemaUpdater databaseSchemaUpdater = db.CreateDatabaseSchemaUpdater();
                    int verson = databaseSchemaUpdater.DatabaseSchemaVersion;
                    if (verson == 0)
                    {
                        databaseSchemaUpdater.AddColumn<Order>("Salesman");
                        databaseSchemaUpdater.AddTable<Company>();
                    ...
                    {
                        databaseSchemaUpdater.AddColumn<Company>("ID");
                        databaseSchemaUpdater.DatabaseSchemaVersion = 3;
                        databaseSchemaUpdater.Execute();
                    }
