...
using DPAPIDataTestDemo.Resources;
using System.IO.IsolatedStorage;
using System.IO;
using System.Security.Cryptography;
using System.Text;

namespace DPAPIDataTestDemo
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private byte[] ReadPinFromFile()
        {
           ...
           // IsolatedStorageFileStream readstream = new IsolatedStorageFileStream("test.txt", System.IO.FileMode.Open, FileAccess.Read, file);
            ...
            Stream reader = Application.GetResourceStream(new Uri("test.txt", UriKind.Relative)).Stream;// new StreamReader(readstream).BaseStream;
