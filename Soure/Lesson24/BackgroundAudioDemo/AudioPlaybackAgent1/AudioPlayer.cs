...
namespace AudioPlaybackAgent1
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        private static List<AudioTrack> audioPlayerList = new List<AudioTrack>
        {
            new AudioTrack(new Uri("Making love without nothing at all.mp3", UriKind.Relative),"Making love without nothing at all", "title","aa"
                ,null,null, EnabledPlayerControls.All),
           new AudioTrack(new Uri("http://www.nmgwxc.com/m/yldcj.mp3", UriKind.Absolute),"test", "title","aa"
                ,null,null, EnabledPlayerControls.All)
        };
        ...
        {
            if (++index >= audioPlayerList.Count)
                index = 0;
            // TODO: 添加逻辑以获取下一条音轨

            AudioTrack track = audioPlayerList[index];
